...
## Roadmap
A detailed feature-by-feature TODO list is available in `ROADMAP.md`.

High-level priorities:
- HTTP core hardening (HTTP/1.1, parsing robustness, streaming)
- Router + middleware (path params, groups, 405 handling)
- Runtime scalability (multi-client, graceful shutdown, timeouts)
- Web framework features (static files, cookies/sessions, auth hooks)
- C++ layer (RAII wrappers and typed handler ergonomics)
